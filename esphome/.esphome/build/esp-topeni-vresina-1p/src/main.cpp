...
void setup() {
  ...
  //   build_path: .esphome/build/esp-topeni-vresina-1p
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("esp-topeni-vresina-1p", __DATE__ ", " __TIME__, false);
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  //   tx_buffer_size: 512
  ...
  wifi_wificomponent->set_use_address("192.168.10.249");
  ...
  wifi_wifiap_3.set_ssid("Esp-Topeni-Vresina-1P");
  wifi_wifiap_3.set_password("bG4rIQClSGVy");
  ...
  ota_otacomponent->set_auth_password("a3637ca2b4b52feef752cf6c91b7a8c9");
  ...
  api_apiserver->set_noise_psk({249, 42, 183, 125, 91, 245, 4, 49, 164, 208, 163, 25, 20, 227, 98, 251, 89, 162, 91, 173, 25, 28, 33, 56, 179, 154, 112, 6, 144, 237, 9, 123});
  // web_server:
  //   port: 80
  ...
  dallas_dallastemperaturesensor->set_name("Dallas_1_patro_temp");
  ...
  dallas_dallastemperaturesensor->set_address(0xD100000729B52C28);
  ...
  sensor_sensor->set_name("DHT22_1_patro_temp");
  ...
  sensor_sensor_2->set_name("DHT22_1_patro_humidity");
